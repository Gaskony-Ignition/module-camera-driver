...
**Connection:**
- IP Address: `192.0.2.10` (your ONVIF device IP)
...
[INFO] Created ONVIF client for http://192.0.2.10:80/onvif/device_service
...
- Try ping: `docker exec ignition-gateway ping 192.0.2.10`
