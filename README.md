...
**Version**: 2.28.0 | **Status**: Production Ready
...
./gradlew clean build
# Output: build/CameraDriver-2.28.0.modl
```

### 2. Install
```bash
docker cp build/CameraDriver-2.28.0.modl ignition-gateway:/usr/local/bin/ignition/user-lib/modules/
