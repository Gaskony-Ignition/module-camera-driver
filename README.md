...
**Version**: 2.34.13 | **Status**: Production Ready
...
./gradlew clean build
# Output: build/CameraDriver-2.34.13.modl
```

### 2. Install
```bash
docker cp build/CameraDriver-2.34.13.modl ignition-gateway:/usr/local/bin/ignition/user-lib/modules/
