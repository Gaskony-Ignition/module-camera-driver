...
import com.onvif.driver.gateway.device.generic.GenericCameraAddressSpaceBuilder;
import com.onvif.driver.gateway.device.generic.GenericCameraClient;
...
public class CameraDevice extends ManagedAddressSpaceWithLifecycle implements Device {
    ...
    private void buildGenericAddressSpace() {
        ...
        com.onvif.driver.gateway.device.generic.GenericCameraConfig syntheticConfig =
            new com.onvif.driver.gateway.device.generic.GenericCameraConfig(
                new com.onvif.driver.gateway.device.generic.GenericCameraConfig.General(true),
                new com.onvif.driver.gateway.device.generic.GenericCameraConfig.CameraConnection(
                ...
                new com.onvif.driver.gateway.device.generic.GenericCameraConfig.StreamSettings(15)
            );
